...
test('correct todolists should be removed', () => {
    const endState = todolists(startState, removeTodolist({todolistId: todolistId1}));
...
test('correct todolists should be added', () => {
    ...
    const endState = todolists(startState, addTodolist({todolist}))
...
test('correct todolists should change its name', () => {
    ...
    const endState = todolists(startState, changeTodolistTitle({todolistId: todolistId2, title: newTodolistTitle}));
...
test('correct filter of todolists should be changed', () => {
    ...
    const endState = todolists(startState, changeFilter({todolistId: todolistId2, filter: newFilter}));
